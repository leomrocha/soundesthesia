  ...
  Vex.Flow.Fretboard = (function() {
    ...
    L = function() {
      ...
      if (Vex.Flow.Fretboard.DEBUG) {
        return typeof console !== "undefined" && console !== null ? console.log.apply(console, ["(Vex.Flow.Fretboard)"].concat(__slice.call(args))) : void 0;
      }
    };
    ...
    Fretboard.prototype.calculateFretPositions = function() {
      var k, num, transform, width, x, _i, _ref;
      L("calculateFretPositions: width=" + this.width);
      width = this.width - this.nut_width;
      this.bridge_to_fret = [width];
      this.fretXs = [0];
      k = 1.05946;
      for (num = _i = 1, _ref = this.total_frets; 1 <= _ref ? _i <= _ref : _i >= _ref; num = 1 <= _ref ? ++_i : --_i) {
    ...
    Fretboard.prototype.hasFret = function(num) {
      ...
      return __indexOf.call((function() {
        _results = [];
        for (var _i = _ref = this.start_fret - 1, _ref1 = this.end_fret; _ref <= _ref1 ? _i <= _ref1 : _i >= _ref1; _ref <= _ref1 ? _i++ : _i--){ _results.push(_i); }
        return _results;
      }).apply(this), num) >= 0;
    };
    ...
    Fretboard.prototype.hasString = function(num) {
      ...
      return __indexOf.call((function() {
        _results = [];
        for (var _i = 1, _ref = this.options.strings; 1 <= _ref ? _i <= _ref : _i >= _ref; 1 <= _ref ? _i++ : _i--){ _results.push(_i); }
        return _results;
      }).apply(this), num) >= 0;
    };
    ...
    Fretboard.prototype.drawMarkers = function() {
      var bottom_dot, drawCircle, middle_dot, position, start, top_dot, y_displacement, _i, _j, _len, _len1, _ref, _ref1, _results;
      L("drawMarkers");
      middle_dot = 3;
      top_dot = 4;
      bottom_dot = 2;
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ...
        if (this.hasFret(position)) {
          ...
          _results.push(drawCircle(start));
        } else {
          _results.push(void 0);
        }
      }
    ...
    Fretboard.prototype.drawFretNumbers = function() {
      var fret, point, position, value, _ref, _results;
      _ref = {
        5: "V",
        12: "XII",
        19: "XIX"
      ...
      for (position in _ref) {
        ...
        if (this.hasFret(fret)) {
          ...
          _results.push(this.renderText(point, value));
        } else {
          _results.push(void 0);
        }
      }
    ...
    Fretboard.prototype.draw = function() {
      var num, _i, _j, _ref, _ref1, _ref2;
      L("draw()");
      for (num = _i = 1, _ref = this.options.strings; 1 <= _ref ? _i <= _ref : _i >= _ref; num = 1 <= _ref ? ++_i : --_i) {
        this.drawString(num);
      }
      for (num = _j = _ref1 = this.start_fret, _ref2 = this.end_fret; _ref1 <= _ref2 ? _j <= _ref2 : _j >= _ref2; num = _ref1 <= _ref2 ? ++_j : --_j) {
        this.drawFret(num);
      }
  ...
  Vex.Flow.FretboardDiv = (function() {
    ...
    L = function() {
      ...
      if (Vex.Flow.FretboardDiv.DEBUG) {
        return typeof console !== "undefined" && console !== null ? console.log.apply(console, ["(Vex.Flow.FretboardDiv)"].concat(__slice.call(args))) : void 0;
      }
    };
    ...
    FretboardDiv.prototype.setOption = function(key, value) {
      if (__indexOf.call(_.keys(this.options), key) >= 0) {
        L("Option: " + key + "=" + value);
    ...
    FretboardDiv.prototype.show = function(line) {
        //console.log("shiowoing line: ", line)
      var match, option, options, params, valid_options, _i, _len, _ref;
      ...
      for (_i = 0, _len = options.length; _i < _len; _i++) {
        option = options[_i];
        option = option.trim();
        //console.log("trying to show, option: ", option);
        //console.log(option === null || option === undefined || option === 'undefined');
        match = option.match(/^(\S+)\s*=\s*(\S+)/);
        if (_ref = match[1], __indexOf.call(valid_options, _ref) < 0) {
          throw error("Invalid 'show' option: " + match[1]);
        }
        if (match != null) {
            //console.log("trying to show match: ", match);
    ...
    FretboardDiv.prototype.parse = function(data) {
      var line, lines, match, _i, _len;
      //console.log("parsing data: ", data);
      L("Parsing: " + data);
      lines = data.split(/\n/);
      //console.log("splitting data to lines: ", lines);
      for (_i = 0, _len = lines.length; _i < _len; _i++) {
        line = lines[_i];
        //console.log("reading line: ", _i," content:", line);
        line.trim();
    ...
    extractNotes = function(str) {
      var extracted_notes, note, notes, parts, _i, _len;
      L("ExtractNotes: ", str);
      str.trim();
      notes = str.split(/\s*,\s*/);
      extracted_notes = [];
    ...
    extractFrets = function(light) {
      var fret, frets, lights, note, notes, string, strings, _i, _j, _k, _len, _len1, _len2;
      if (light.fret != null) {
      ...
      if (notes != null) {
        for (_k = 0, _len2 = notes.length; _k < _len2; _k++) {
          note = notes[_k];
          lights.push(note);
        }
      }
    ...
    FretboardDiv.prototype.lightsCameraAction = function() {
      var light, param, params, _i, _len, _ref, _results;
      L(this.lights);
      _ref = this.lights;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (_j = 0, _len1 = params.length; _j < _len1; _j++) {
            ...
            if (light.text != null) {
              ...
              _results1.push(this.fretboard.lightText(param));
            } else {
              _results1.push(this.fretboard.lightUp(param));
            }
          }
          return _results1;
        }).call(this));
